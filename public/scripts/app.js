...
var Student = function (_Person) {
  ...
  function Student(name, age, major) {
    ...
    //when a new instance is created super calls the constructor function of the parent class.
...
var Traveler = function (_Person2) {
  ...
  function Traveler(name, age, getLocation) {
    _classCallCheck(this, Traveler);

    var _this2 = _possibleConstructorReturn(this, (Traveler.__proto__ || Object.getPrototypeOf(Traveler)).call(this, name, age));

    _this2.getLocation = getLocation;
    return _this2;
  }
...
var traveler = new Traveler('Adoniram Vargas', 47, 'Miami');
